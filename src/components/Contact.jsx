...
export default function Contact() {
  return (
    <div className='w-full overflow-hidden py-20 relative flex justify-center items-center container'>
        <div className='w-[50%] h-full flex flex-col items-center blur-bg p-4 border-2 border-black rounded-lg'>
            ...
            <div className='text-2xl text-white mb-12 text-center font-Chewy'>
